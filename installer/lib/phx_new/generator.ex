  ...
  case @phoenix_version do
    %Version{pre: "dev"} ->
      defp phoenix_dep("deps/phoenix") do
        ~s[{:phoenix, github: "bhtabor/phoenix", branch: "turbo/phx-dev", override: true}]
      end

    %Version{pre: ["rc", _]} ->
      defp phoenix_dep("deps/phoenix") do
        ~s[{:phoenix, github: "bhtabor/phoenix", branch: "turbo/phx-#{unquote(to_string(@phoenix_version))}", override: true}]
      end

    %Version{} ->
      defp phoenix_dep("deps/phoenix") do
        ~s[{:phoenix, github: "bhtabor/phoenix", branch: "turbo/phx-#{unquote(to_string(@phoenix_version))}"}]
      end
  end
