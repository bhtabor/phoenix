defmodule Phx.New.Web do
  ...
  template(:html, [
    {:eex, :web,
     ...
     "phx_web/controllers/turbo/plug.ex": "lib/:web_app/controllers/turbo/plug.ex",
     "phx_web/controllers/turbo/controller.ex": "lib/:web_app/controllers/turbo/controller.ex",
     "phx_web/controllers/turbo/stream.ex": "lib/:web_app/controllers/turbo/stream.ex",
